                        ...
                        <div class="post">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    echo '<td><a  href="'.WWW_ROOT .'intranets/viewMail/'.$receipt->id_mail.'">
                                    Voir</a></td>';
                                    echo '<td>'.$receipt->envoi.'</td>';
                                    echo '<td><a  href="'.WWW_ROOT .'intranets/signalement/'.$receipt->id_mail.'">
                                    Signaler</a></td>';
                                    echo '<td><a  href="'.WWW_ROOT .'intranets/mail/'.$receipt->id_expediteur.'">
                                    Répondre</a></td>';                                  
                                    echo '<td><a  href="'.WWW_ROOT .'intranets/delete/'.$receipt->id_mail.'">
                                    Delete</a></td>';
                                    echo "</tr>";
                                    }   
                        ...
                        <div class="post">
                            ...
                            <table class="table table-hover">
                                ...
                                foreach($data['sent'] as $sent){
                                    ...
                                    echo '<td><a  href="'.WWW_ROOT .'intranets/delete/'.$sent->id_mail.'">
                                    Delete</a></td>';
                                    echo "</tr>";
                                    }   
