        ...
        <div class="container">
                <div class="row">
                    ...
                    <?php echo '<a href="'.WWW_ROOT.'posts/home">HOME ></a>'; 
                     echo '<a href="'.WWW_ROOT.'posts/home">TOPIC: '.$data["topic"]->titre.'</a>'; 
                     echo  '<a href="'.WWW_ROOT.'conversations/listConversations/'.$data["topic"]->id.'"> > CONVERSATION: '.$data['conversation']->titre.'</a>';
                    ?>
                     </div>
                </div>
            </div>                
                            ...
                            <?php foreach($data['messages'] as $message){                                                                          
                                   ...
                                   <div class="wrap-ut pull-left">
                                       <div class="userinfo pull-left">
                                           <div class="avatar">';
                                               echo '<a href="'.WWW_ROOT.'users/vueProfil/'.$message->id_utilisateur.'"><img src="'.WWW_ROOT.'public/images/avatars/'.$message->avatar.'.png " alt="" /></a>';
                                        ...
                                        if(isLoggedIn()){
                                            echo '<a href="'.WWW_ROOT.'messages/liked/'.$message->id.'/'.$message->id_conversation.'" class="up"><i class="fa fa-thumbs-up"></i>'.$liked.'</a>
                                            <a href="'.WWW_ROOT.'messages/disliked/'.$message->id.'/'.$message->id_conversation.'" class="down"><i class="fa fa-thumbs-down"></i>'.$disliked.'</a>';
                                        }else{
                                            echo '<a href="#" class="up"><i class="fa fa-thumbs-up"></i>'.$liked.'</a>
                                            <a href="#" class="down"><i class="fa fa-thumbs-down"></i>'.$disliked.'</a>';
                                        } 
                                       
                                       if(isLoggedIn() && $message->role!='admin' && $message->signalement=='0'){ echo '&nbsp;&nbsp;&nbsp;&nbsp;<a  href="'.WWW_ROOT .'messages/signalement/'.$message->id.'/'.$message->id_conversation.'">
                                ...
                                <div class="postinfo pull-left">
                                    ...
                                    if(isLoggedIn() && $_SESSION['role']!='membre'){
                                        echo '<div class="views"><a href="'. WWW_ROOT.'messages/modify/'.$message->id.'"> <i class="fa fa-eye"></i> modifier</a></div>';} 
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="sidebarblock">
                            ...
                            <?php if(!isLoggedIn()){ ?>
                                ...
                                <?php }else{ ?>
                                <form action="<?php echo WWW_ROOT; ?>messages/createMessage" class="form newtopic" method="post">
