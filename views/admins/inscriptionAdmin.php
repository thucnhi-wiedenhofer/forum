                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            ...
                            <!-- POST -->
                            <div class="post">
                                <form class="form newtopic" action="<?php echo WWW_ROOT; ?>admins/inscription" method ="POST">
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-2 col-md-3">
                                                                <div class="checkbox">
                                                                    <label>
                                                                    <img src="<?php echo WWW_ROOT; ?>public/images/avatars/admin.jpg" alt="admin">
                        ...
                        <div class="col-lg-4 col-md-4">
                            ...
                            <img src="<?php echo WWW_ROOT; ?>public/images/cyberpunk.jpg" alt="cyber">
                            </div>
