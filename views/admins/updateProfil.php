        ...
        <section class="content">
                <div class="container">
                    <div class="row">
                        ...
                        <a href="<?php echo  WWW_ROOT.'admins/crud';?>">CRUD ></a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            ...
                            <!-- POST -->
                            <div class="post">
                                <form class="form newtopic" action="<?php echo WWW_ROOT; ?>admins/updateProfil" method ="POST">
                        ...
                        <div class="col-lg-4 col-md-4">
                            ...
                            <img src="<?php echo WWW_ROOT; ?>public/images/blackmirror.jpg" alt="black mirror">
                            </div>
